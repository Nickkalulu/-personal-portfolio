...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] relative overflow-hidden flex items-center">
      {/* Soft overlay effect */}
      <div className="absolute inset-0 bg-[radial-gradient(circle,_rgba(255,255,255,0.05)_0%,_transparent_70%)] animate-pulse opacity-20 pointer-events-none" />

      {/* Floating Decorative Elements */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-16 left-12 w-32 h-32 bg-tech-cyan/20 rounded-full animate-float" />
        <div className="absolute bottom-20 right-12 w-40 h-40 bg-tech-pink/20 rounded-full animate-float" style={{ animationDelay: '2s' }} />
        <div className="absolute top-1/3 right-1/3 w-16 h-16 bg-tech-purple/20 rounded-full animate-float" style={{ animationDelay: '4s' }} />
      </div>
          ...
          <div className="relative animate-fade-in" style={{ animationDelay: '0.3s' }}>
            <div className="relative z-10 group">
              <img
                ...
                className="w-72 h-72 md:w-96 md:h-96 object-cover mx-auto rounded-full shadow-xl group-hover:scale-105 transition-spring"
              />
            ...
            <div className="absolute -top-6 -right-6 w-28 h-28 bg-tech-purple/15 rounded-full backdrop-blur-sm rotate-12 animate-float" />
